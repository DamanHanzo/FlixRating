(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
	        ...
	        controller:'FlixRatingListController'
	    }).state('viewFlixRating',{
	       url:'/flixRatings/:id/view',
	       templateUrl: viewsPrefix + 'shipwreck-view.html',
	       controller:'FlixRatingViewController'
	    }).state('newFlixRatings',{
	        url:'/flixRatings/new',
	        templateUrl: viewsPrefix + 'shipwreck-add.html',
	        controller:'FlixRatingCreateController'
	    }).state('editFlixRating',{
